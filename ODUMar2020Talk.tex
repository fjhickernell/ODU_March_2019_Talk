...
\begin{frame}
	...
	\includegraphics[width = 0.32\textwidth]{ProgramsImages/GAILatSIAM2018.jpg} \ 
	\includegraphics[width = 0.32\textwidth]{ProgramsImages/GAILatChinatown2018.png}
	...
	\item Yizhi Zhang (IIT PhD '18)
	
	\item Xuan Zhou (IIT PhD '15, JP Morgan)
	
	\item and others
	
	\item \href{https://github.com/QMCSoftware/QMCSoftware}{\beamerbutton{GAIL}} and 
